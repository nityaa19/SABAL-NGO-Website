      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
            Your privacy is important to us. Last updated: April 20, 2022
          </p>
        </div>
        ...
        <div className="mt-16 flex justify-center">
          <Card className="w-full max-w-4xl">
            ...
            <CardContent className="prose max-w-none text-muted-foreground p-6 md:p-8 space-y-4">
              ...
              <h2 className="font-semibold text-foreground">Collecting and Using Your Personal Data</h2>
              ...
              <h3 className="font-semibold text-foreground">Tracking Technologies and Cookies</h3>
              ...
              <h2 className="font-semibold text-foreground">Changes to this Privacy Policy</h2>
